...
<?php 
    require_once("../MIDDLEWARE/is-collab-check.php");
    ...
    $connect = OpenCon();
    $query = "SELECT full_name FROM student WHERE user_id = " . $_SESSION['user_id'];
        ...
        <nav id="ham-menu">
            <div>
                ...
                <ul>
                    ...
                    <li><a href="meeting.php">SHEDULE MEETING</a></li>
                    <li><a href="chat.php">CHAT ROOM</a></li>
                    <li><a href="project-student.php">PROJECT</a></li>
